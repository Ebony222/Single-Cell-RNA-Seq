...
setwd("/Documents/Single-cell-RNA-Seq/scripts")
...
nsclc.sparse.m <- Read10X_h5(filename = 'C:/Users/rofia/OneDrive/Documents/Single-Cell-RNA-Seq/data/20k_NSCLC_DTC_3p_nextgem_Multiplex_count_raw_feature_bc_matrix.h5')
str(nsclc.sparse.m)
